...
# NuGetExample
exec dotnet publish ./Example/RestoreExample -c Debug
exec dotnet publish ./Example/RestoreExample /p:Trigger=hoge
exec dotnet publish ./Example/RestoreExample -c Debug /p:Trigger=piyo